...
export default function Favfixture() {
                            ...
                            (
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <div class="rate">
                                    <input onClick={({UpdateProfile}) => {
  
                                            navigate(`/tracking/${id}`); //TODO go to match
                                        }} type="radio" id="star5" name="rate" value="5" />
                                    <label onClick={() => {
                                            navigate(`/tracking/${id}`); //TODO go to match
                                        }} for="star5" title="Add this match to favourite">5 stars</label>
                                    </div>
                                    </div>    
                                        </div>
