          ...
          {team ?
            <div style={{width: "100%"}}>
              ...
              <div className="side-by-side" style={{paddingBottom: 20}}>
                <img className="teamLogo" style={{paddingLeft: "10vw"}}
                src={team.anthem}
                alt={team.alt}/>
                <div className="top-to-bottom"   style={{paddingLeft: "20vw", paddingTop: "10px", lineHeight: "0px"}}>
                  <h3>Team Manager: <span style={{fontWeight: "normal",}}>{team.coach}</span></h3>
